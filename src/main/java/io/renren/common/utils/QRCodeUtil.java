...
public class QRCodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        //二维码内容
        String content = "https://cnblogs.com/mww-NOTCOPY/";

        //Logo地址
        String logoPath= "E:\\Git\\image\\2019.png";

        String destPath= "E:\\Git\\express-fast\\src\\main\\resources\\static\\template\\";
        ...
        //含Logo，指定二维码图片名
        QRCodeUtil.encode(content, logoPath, destPath, "QRCode", true);
    }
}
